...
export default function profile() {
  ...
  const handleFile = (e) => {
    ...
    const validImageTypes = ["image/git", "image/jpeg", "image/png"];
  ...
  const inputClassName =
    "block p-4 w-full text-sm text-gray-900 border border-gray-300 rounded-lg gb-gray-50 focus:ring-blue-500 focus:border-blue-500";
