  ...
  return (
    <div className="bg-[#0d084d] px-20 py-16 flex gap-10">
      <div className="text-white flex flex-col gap-6 justify-center items-start">
        ...
        <h1 className="text-3xl font-bold">A solution built for business</h1>
        <h4 className="text-xl">
          Upgrae to a curated experience to access vette talent and exclusive
          tools
        </h4>
        <ul className="flex flex-col gap-4">
          <li className="flex gap-2 itens-center">
